...
@Service
public class MensagemEmailRedefinirSenha {
        ...
        public void enviarConfirmacao(String emailUsuario, String nomeUsuario) {
            ...
            try {
                ...
                message.setSubject("Confirmação de atualização de senha Realizada!");

                // O conteúdo da mensagem
                String corpoEmail = nomeUsuario + ",\n\n"
                        + "Este é um e-mail automático para confirmar que a sua senha foi atualizada.";
